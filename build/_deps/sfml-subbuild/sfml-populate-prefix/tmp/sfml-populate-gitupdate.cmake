...
execute_process(
  COMMAND "D:/Git/Git/cmd/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "E:/OOP/homework/lab/final/sfSnake/build/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/OOP/homework/lab/final/sfSnake/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/OOP/homework/lab/final/sfSnake/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
